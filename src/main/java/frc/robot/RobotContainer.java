...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    m_chooser.addOption("Drive Distance PID", new DriveDistancePID(100, m_drivetrain));
    m_chooser.addOption("Turn to Angle PID", new TurnToAnglePID(90, m_drivetrain));
    m_chooser.addOption("Drive Distance PID Profiled", new DriveDistanceProfiled(100, m_drivetrain));
    m_chooser.addOption("Turn to Angle PID Profiled", new TurnToAngleProfiled(90, m_drivetrain));
